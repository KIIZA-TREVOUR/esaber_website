    ...
    <div class="row align-items-center">
      <div class="col-lg-12">
        <div class="hero-header">
          <h1 class="text-anime-style-1">Our Blog</h1>
          <div class="space28"></div>
          <a href="index.html" class="bradecrumb">Home <i class="fa-solid fa-angle-right"></i> Our Blog</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="vl-blog-4-area-inner sp2">
    <div class="container">
       ...
       <div class="col-lg-4 col-md-6">
        ...
        <div class="vl-blog-1-item">
            <div class="vl-blog-1-thumb image-anime">
                <img src="assets/img/all-images/blog/blog-img21.png" alt="">
            </div>
            <div class="vl-blog-1-content">
              <div class="vl-blog-meta">
                 <ul>
...
<!--===== CTA AREA STARTS =======-->
<div class="cta4-section-area" style="background-image: url(assets/img/all-images/bg/bg5.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-5">
      ...
      <div class="col-lg-4">
        <div class="cta-circle-area">
            <div class="bg1">
                <img src="assets/img/all-images/bg/cta-bg1.png" alt="" class="cta-bg1">
            </div>
          <div class="img1">
            <img src="assets/img/all-images/cta/cta-img4.png" alt="">
          </div>
        </div>
      </div>
    </div>
